      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
        <div>
          <p className="text-gray-700 mb-6 leading-relaxed">
            Інтернет-провайдер "Велес" — це сучасна телекомунікаційна компанія, яка надає послуги високошвидкісного доступу до мережі Інтернет у Чернівцях та області. Ми працюємо з 2019 року і за цей час завоювали довіру багатьох клієнтів завдяки відмінній якості зв'язку та високому рівню обслуговування.
          </p>
